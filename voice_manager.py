...
class VoiceManager:
    ...
    async def remove_broken_client(
        ...
        logger.warning(
            "Ungültige Voice-Sitzung wird entfernt."
        )
    ...
    async def connect_new(
        ...
        voice_client = await channel.connect(
            ...
            # Wichtig:
            # discord.py soll NICHT zusätzlich
            # selbst reconnecten.
            reconnect=False,

            # Der Bot hört niemanden ab.
            self_deaf=True,

            # Der Bot muss sprechen dürfen,
            # damit der Sound hörbar ist.
            self_mute=False,
        )
    ...
    async def monitor(self) -> None:
        ...
        while not self.client.is_closed():
            try:
                ...
                logger.exception(
                    "Dem Bot fehlen Rechte: "
                    "Kanal ansehen, Verbinden "
                    "oder Sprechen."
                )
                ...
                logger.exception(
                    "Voice-Verbindung hat zu lange "
                    "gedauert. Neuer Versuch "
                    "in 10 Sekunden."
                )
